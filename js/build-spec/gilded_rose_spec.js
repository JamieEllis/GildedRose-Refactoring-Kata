...
function qualityNeverNegative(itemName) {
  ...
  const shop = new _gilded_rose.Shop([new _gilded_rose.Item(itemName, 5, 0)]);
...
function qualityNeverGoesAboveFifty(itemName) {
  ...
  const shop = new _gilded_rose.Shop([new _gilded_rose.Item(itemName, 5, 50)]);
  const items = shop.updateQuality();
...
describe('Gilded Rose', () => {
  ...
  describe('items', () => {
    ...
    it('sell-in value decreases by one each day', () => {
      const shop = new _gilded_rose.Shop([new _gilded_rose.Item('Default item', 5, 0)]);
      const items = shop.updateQuality();
    ...
    describe('default', () => {
      ...
      it('unexpired: quality decreases by one each day', () => {
        const shop = new _gilded_rose.Shop([new _gilded_rose.Item('Default Item', 5, 5)]);
        const items = shop.updateQuality();
      ...
      it('unexpired conjured: quality decreases by two each day', () => {
        const shop = new _gilded_rose.Shop([new _gilded_rose.Item('Conjured Default Item', 5, 5)]);
        const items = shop.updateQuality();
        items[0].quality.should.equal(3);
      });
    ...
    describe('sulfuras', () => {
      ...
      it('quality never decreases', () => {
        const shop = new _gilded_rose.Shop([new _gilded_rose.Item('Sulfuras, Hand of Ragnaros', 5, 5)]);
        const items = shop.updateQuality();
        items[0].quality.should.be.least(5);
      });

      it('sell-in never decreases', () => {
        const shop = new _gilded_rose.Shop([new _gilded_rose.Item('Sulfuras, Hand of Ragnaros', 5, 0)]);
        const items = shop.updateQuality();
    ...
    describe('backstage passes', () => {
      ...
      it('quality increases by one when more than 10 days until concert', () => {
        const shop = new _gilded_rose.Shop([new _gilded_rose.Item('Backstage passes to a TAFKAL80ETC concert', 50, 5)]);
        const items = shop.updateQuality();
        items[0].quality.should.equal(6);
      });

      it('quality increases by two when more than 5 days but less than or equal to 10 days until concert', () => {
        const shop = new _gilded_rose.Shop([new _gilded_rose.Item('Backstage passes to a TAFKAL80ETC concert', 7, 5)]);
        const items = shop.updateQuality();
        items[0].quality.should.equal(7);
      });

      it('quality increases by three when less than or equal to 5 days until concert', () => {
        const shop = new _gilded_rose.Shop([new _gilded_rose.Item('Backstage passes to a TAFKAL80ETC concert', 3, 5)]);
        const items = shop.updateQuality();
